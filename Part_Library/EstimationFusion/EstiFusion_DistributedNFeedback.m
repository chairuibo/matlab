function [ kalman_x_update,estimate_data ] = EstiFusion_DistributedNFeedback(model,measureData )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%程序说明:分布式融合系统，不带反馈的最优分布式估计融合算法
%参数说明:model  运动模型
...
function  [x_out,P_out]= SingleStepMultiple(model,x_Global_update,P_Global_update,SensorData)
 ...
 %%%kernel     
    ...
    x_Gp =  model.F * x_Gu;
    for j=1:SensorCount
        invP_temp = invP_temp + invP_2{j}-invP_1{j};
        invPx_temp = invPx_temp + invP_2{j}*x_2{j}-invP_1{j}*x_1{j};
    end
